...
export default function ProductModal({ product, collections, onClose, onSuccess }: ProductModalProps) {
  ...
  const validateForm = (): boolean => {
    ...
    if (formData.price <= 0) {
      ...
      newErrors.wholeSalePrice = 'Price must be greater than 0';
    }
            ...
            <div className="border-t pt-4">
              ...
              <div className="space-y-3">
                ...
                <p className="text-xs text-gray-500">
                  Select multiple images to upload them directly to this product. Supported formats: JPEG, PNG, GIF, WebP (max 10MB each)
                </p>
              </div>
            </div>
          </div>
